...
# Reward values strictly in (0, 1) per step
REWARD_CORRECT_BLOCK = 0.99
REWARD_FALSE_POSITIVE = 0.00
REWARD_KILL_PID = 0.49
REWARD_DELETE_FILE = 0.50
REWARD_STEP_PENALTY = 0.00
REWARD_WRONG_TOOL = 0.00
MAX_STEPS = 8
